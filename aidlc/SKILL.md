...
### Path B: New Project — ask human for name/language/purpose, scaffold, commit as `v0.1.0`
...
Write throwaway code in `scratch_dir` to prove the idea works. Gitignored, nothing committed.

> **Skip condition**: trivial changes → note "Phase 2: skipped (trivial)" in version log.

### Phase 3: Implement

Minimal code. No drive-by refactors. No test modifications unless human requests.
